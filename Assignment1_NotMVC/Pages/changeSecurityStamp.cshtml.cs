...
{
    public class changeSecurityStampModel : PageModel
    {
        ...
        public changeSecurityStampModel(UserManager<ApplicationUser> userManager, AuditLogServices auditLogServices)
        {
